...
public class Dm_Exhibit_video implements org.apache.thrift.TBase<Dm_Exhibit_video, Dm_Exhibit_video._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("Dm_Exhibit_video");
  ...
  static {
    schemes.put(StandardScheme.class, new Dm_Exhibit_videoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new Dm_Exhibit_videoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Dm_Exhibit_video.class, metaDataMap);
  }

  public Dm_Exhibit_video() {
  }
   ...
   */
  public Dm_Exhibit_video(Dm_Exhibit_video other) {
    if (other.isSetEid()) {
      this.eid = other.eid;
    }
  ...
  public Dm_Exhibit_video deepCopy() {
    return new Dm_Exhibit_video(this);
  }
  ...
  public Dm_Exhibit_video setEid(String eid) {
    this.eid = eid;
    return this;
  }
  ...
  public Dm_Exhibit_video setThumbnail_url(String thumbnail_url) {
    this.thumbnail_url = thumbnail_url;
    return this;
  }
  ...
  public Dm_Exhibit_video setAttachurl(String attachurl) {
    this.attachurl = attachurl;
    return this;
  }
  ...
  public Dm_Exhibit_video setOri_name(String ori_name) {
    this.ori_name = ori_name;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof Dm_Exhibit_video)
      return this.equals((Dm_Exhibit_video)that);
    return false;
  }

  public boolean equals(Dm_Exhibit_video that) {
    if (that == null)
      return false;
  ...
  public int compareTo(Dm_Exhibit_video other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    Dm_Exhibit_video typedOther = (Dm_Exhibit_video)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("Dm_Exhibit_video(");
    boolean first = true;
  ...
  private static class Dm_Exhibit_videoStandardSchemeFactory implements SchemeFactory {
    public Dm_Exhibit_videoStandardScheme getScheme() {
      return new Dm_Exhibit_videoStandardScheme();
    }
  }

  private static class Dm_Exhibit_videoStandardScheme extends StandardScheme<Dm_Exhibit_video> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Dm_Exhibit_video struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Dm_Exhibit_video struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class Dm_Exhibit_videoTupleSchemeFactory implements SchemeFactory {
    public Dm_Exhibit_videoTupleScheme getScheme() {
      return new Dm_Exhibit_videoTupleScheme();
    }
  }

  private static class Dm_Exhibit_videoTupleScheme extends TupleScheme<Dm_Exhibit_video> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Dm_Exhibit_video struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Dm_Exhibit_video struct) throws org.apache.thrift.TException {
