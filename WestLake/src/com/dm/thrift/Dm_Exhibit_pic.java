...
public class Dm_Exhibit_pic implements org.apache.thrift.TBase<Dm_Exhibit_pic, Dm_Exhibit_pic._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("Dm_Exhibit_pic");
  ...
  static {
    schemes.put(StandardScheme.class, new Dm_Exhibit_picStandardSchemeFactory());
    schemes.put(TupleScheme.class, new Dm_Exhibit_picTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Dm_Exhibit_pic.class, metaDataMap);
  }

  public Dm_Exhibit_pic() {
  }
   ...
   */
  public Dm_Exhibit_pic(Dm_Exhibit_pic other) {
    if (other.isSetEid()) {
      this.eid = other.eid;
    }
  ...
  public Dm_Exhibit_pic deepCopy() {
    return new Dm_Exhibit_pic(this);
  }
  ...
  public Dm_Exhibit_pic setEid(String eid) {
    this.eid = eid;
    return this;
  }
  ...
  public Dm_Exhibit_pic setThumbnail_url(String thumbnail_url) {
    this.thumbnail_url = thumbnail_url;
    return this;
  }
  ...
  public Dm_Exhibit_pic setAttachurl(String attachurl) {
    this.attachurl = attachurl;
    return this;
  }
  ...
  public Dm_Exhibit_pic setOri_name(String ori_name) {
    this.ori_name = ori_name;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof Dm_Exhibit_pic)
      return this.equals((Dm_Exhibit_pic)that);
    return false;
  }

  public boolean equals(Dm_Exhibit_pic that) {
    if (that == null)
      return false;
  ...
  public int compareTo(Dm_Exhibit_pic other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    Dm_Exhibit_pic typedOther = (Dm_Exhibit_pic)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("Dm_Exhibit_pic(");
    boolean first = true;
  ...
  private static class Dm_Exhibit_picStandardSchemeFactory implements SchemeFactory {
    public Dm_Exhibit_picStandardScheme getScheme() {
      return new Dm_Exhibit_picStandardScheme();
    }
  }

  private static class Dm_Exhibit_picStandardScheme extends StandardScheme<Dm_Exhibit_pic> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Dm_Exhibit_pic struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Dm_Exhibit_pic struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class Dm_Exhibit_picTupleSchemeFactory implements SchemeFactory {
    public Dm_Exhibit_picTupleScheme getScheme() {
      return new Dm_Exhibit_picTupleScheme();
    }
  }

  private static class Dm_Exhibit_picTupleScheme extends TupleScheme<Dm_Exhibit_pic> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Dm_Exhibit_pic struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Dm_Exhibit_pic struct) throws org.apache.thrift.TException {
