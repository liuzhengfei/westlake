...
public class Dm_User_Result implements org.apache.thrift.TBase<Dm_User_Result, Dm_User_Result._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("Dm_User_Result");
  ...
  private static final org.apache.thrift.protocol.TField VALIDSTRING_FIELD_DESC = new org.apache.thrift.protocol.TField("validstring", org.apache.thrift.protocol.TType.STRING, (short)3);
  ...
  static {
    schemes.put(StandardScheme.class, new Dm_User_ResultStandardSchemeFactory());
    schemes.put(TupleScheme.class, new Dm_User_ResultTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    VALIDSTRING((short)3, "validstring"),
    USER((short)4, "user");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Dm_User_Result.class, metaDataMap);
  }

  public Dm_User_Result() {
  }
   ...
   */
  public Dm_User_Result(Dm_User_Result other) {
  ...
  public Dm_User_Result deepCopy() {
    return new Dm_User_Result(this);
  }
  ...
  public Dm_User_Result setIsSucess(boolean isSucess) {
    this.isSucess = isSucess;
    setIsSucessIsSet(true);
    return this;
  }
  ...
  public Dm_User_Result setMessage(String message) {
    this.message = message;
    return this;
  }
  ...
  public Dm_User_Result setValidstring(String validstring) {
    this.validstring = validstring;
    return this;
  }
  ...
  public Dm_User_Result setUser(Dm_User user) {
    this.user = user;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof Dm_User_Result)
      return this.equals((Dm_User_Result)that);
    return false;
  }

  public boolean equals(Dm_User_Result that) {
    if (that == null)
      return false;
  ...
  public int compareTo(Dm_User_Result other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    Dm_User_Result typedOther = (Dm_User_Result)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("Dm_User_Result(");
    boolean first = true;
  ...
  private static class Dm_User_ResultStandardSchemeFactory implements SchemeFactory {
    public Dm_User_ResultStandardScheme getScheme() {
      return new Dm_User_ResultStandardScheme();
    }
  }

  private static class Dm_User_ResultStandardScheme extends StandardScheme<Dm_User_Result> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Dm_User_Result struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Dm_User_Result struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class Dm_User_ResultTupleSchemeFactory implements SchemeFactory {
    public Dm_User_ResultTupleScheme getScheme() {
      return new Dm_User_ResultTupleScheme();
    }
  }

  private static class Dm_User_ResultTupleScheme extends TupleScheme<Dm_User_Result> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Dm_User_Result struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Dm_User_Result struct) throws org.apache.thrift.TException {
