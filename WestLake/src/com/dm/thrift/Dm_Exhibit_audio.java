...
public class Dm_Exhibit_audio implements org.apache.thrift.TBase<Dm_Exhibit_audio, Dm_Exhibit_audio._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("Dm_Exhibit_audio");
  ...
  static {
    schemes.put(StandardScheme.class, new Dm_Exhibit_audioStandardSchemeFactory());
    schemes.put(TupleScheme.class, new Dm_Exhibit_audioTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Dm_Exhibit_audio.class, metaDataMap);
  }

  public Dm_Exhibit_audio() {
  }
   ...
   */
  public Dm_Exhibit_audio(Dm_Exhibit_audio other) {
    if (other.isSetEid()) {
      this.eid = other.eid;
    }
  ...
  public Dm_Exhibit_audio deepCopy() {
    return new Dm_Exhibit_audio(this);
  }
  ...
  public Dm_Exhibit_audio setEid(String eid) {
    this.eid = eid;
    return this;
  }
  ...
  public Dm_Exhibit_audio setThumbnail_url(String thumbnail_url) {
    this.thumbnail_url = thumbnail_url;
    return this;
  }
  ...
  public Dm_Exhibit_audio setAttachurl(String attachurl) {
    this.attachurl = attachurl;
    return this;
  }
  ...
  public Dm_Exhibit_audio setOri_name(String ori_name) {
    this.ori_name = ori_name;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof Dm_Exhibit_audio)
      return this.equals((Dm_Exhibit_audio)that);
    return false;
  }

  public boolean equals(Dm_Exhibit_audio that) {
    if (that == null)
      return false;
  ...
  public int compareTo(Dm_Exhibit_audio other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    Dm_Exhibit_audio typedOther = (Dm_Exhibit_audio)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("Dm_Exhibit_audio(");
    boolean first = true;
  ...
  private static class Dm_Exhibit_audioStandardSchemeFactory implements SchemeFactory {
    public Dm_Exhibit_audioStandardScheme getScheme() {
      return new Dm_Exhibit_audioStandardScheme();
    }
  }

  private static class Dm_Exhibit_audioStandardScheme extends StandardScheme<Dm_Exhibit_audio> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Dm_Exhibit_audio struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Dm_Exhibit_audio struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class Dm_Exhibit_audioTupleSchemeFactory implements SchemeFactory {
    public Dm_Exhibit_audioTupleScheme getScheme() {
      return new Dm_Exhibit_audioTupleScheme();
    }
  }

  private static class Dm_Exhibit_audioTupleScheme extends TupleScheme<Dm_Exhibit_audio> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Dm_Exhibit_audio struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Dm_Exhibit_audio struct) throws org.apache.thrift.TException {
