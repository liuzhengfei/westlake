...
public class HomePageExhibitionActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listview = (RefreshableView) findViewById(R.id.exhibitionlistview);
	...
	Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			if (_ooresult != null) {
				...
				_listAdapter = new ListADAdapter(
						HomePageExhibitionActivity.this, _resultList);
			}
			...
			listview.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					Intent mIntent = new Intent(
							HomePageExhibitionActivity.this,
