...
public class HomePageShowActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.home_page_show);

		moreView = getLayoutInflater().inflate(R.layout.loadmore, null);

		listview = (RefreshableView) findViewById(R.id.showlistview);
	...
	Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			if (_ooresult != null) {
				...
				_listAdapter = new ListADAdapter(HomePageShowActivity.this,
						_resultList);
			}
