...
public class SildingCenterEssayDetail extends Activity implements OnClickListener{

	private String _suibiId;
	private EssayDetailAdapter _adapter;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.silding_center_essay_page_detail);
		initGetData();
		initView();
		initCommentData();
	}
	...
	private void initView() {
		_adapter = new EssayDetailAdapter(this, _olist);
		_mListView = (CustomListView) findViewById(R.id.essay_detail_fullrefresh);
		_backBt = (Button) findViewById(R.id.essay_detail_titile_left);
		_backTv = (TextView) findViewById(R.id.essay_detail_titile_lefttx);
		_transTv = (TextView) findViewById(R.id.essay_detail_transmit);
		_commentTv = (TextView) findViewById(R.id.essay_detail_comment);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.essay_detail_titile_left:
			this.finish();
			break;
		case R.id.essay_detail_titile_lefttx:
			this.finish();
			break;
		case R.id.essay_detail_transmit:
			...
			break;
		case R.id.essay_detail_comment:
		...
		_contentIV.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (_t != null && !"".equals(_t) && !"null".equals(_t)) {
					Intent _intent = new Intent(SildingCenterEssayDetail.this,
							SildingCenterScreenImgActivity.class);
					_intent.putExtra("large_img", (String) v.getTag());
					SildingCenterEssayDetail.this.startActivity(_intent);
				}
			}
		});
	...
	private class EssayDetailAdapter extends BaseAdapter {

		private LayoutInflater mInflater;
		private List<Map<String, Object>> resultList;

		public EssayDetailAdapter(Context pContext,
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder._contentRp.setOnClickListener(new OnClickListener() {
				@Override
				public void onClick(View v) {
					Intent _intent = new Intent(SildingCenterEssayDetail.this,SildingCenterStoryRepl.class);
